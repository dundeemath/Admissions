...
## Types of careers graduates have
...
* Single honours Mathematics degrees (almost all mathematics modules)
* Joint Honours (50% modules in mathematics, e.g. with Accountancy, Economics, Physics, Life Sciences, Psychology)
* Mathematics with flavours (e.g. Mathematics with Data Science)
* Flexibility in structure of degree pathways

## What mathematics would you learn?

* Core mathematics, building from your knowledge of algebra, calculus and geometry

. . . 

* New mathematics (e.g. topics in pure mathematics, differential geometry, analysis, vector calculus, statistics)

. . .

* Applying mathematics (e.g.  to physics, biology, finance, data science)

## What transferable skills would you learn?

* Problem solving

. . .

*  Computer programs for  mathematical problems
...
* Communication skills (presentations, writing reports etc.)

## Final year project 


![](PosterSessionApril2025.mp4)

## Mathematics entry requirements at UoD

#### Higher Mathematics

Mathematics, Physics, Engineering, Computer Science, Accountancy and Finance

(note: this is not exhaustive)

####  If up to Nat 5 Mathematics required

Applications for Mathematics is accepted for most degrees (but not Medicine and Dentistry).
...
The value of an endowment policy increases at the rate of 5 $\%$ per annum. The initial value is £7000. How much is the policy worth after two years?
...
## Writing a computer program to simulate the solution
...
app_ui = ui.page_fluid(
    ui.layout_sidebar(
        ui.sidebar(
    ui.input_slider(id="a",label="Interest rate (%)",min=0.0,max=100.0,value=5,step=0.001),
...
## The logistic map: a nonlinear recurrence relation
...
* Relatively simple systems can exhibit complex behaviours

* Studying chaos in simplified settings allows us to understand behaviour in more complex settings (e.g. climate modelling, weather forecasting, financial markets)

* Studying mathematics enable us to become *logical numerate problem solvers*
