---
title: "Applicant Visit Day 2026"
format: 
    html:
...
![](DundeeMathsAdmissionsQRCode.png){width=200 fig-align="center"}



This worksheet is accompanied by web apps that can be found here (https://dundeemath.github.io/Admissions/, also see QR code).
...
1. Hold a small number of rice grains above the circle in @fig-circ and drop onto the page. Vary the dropping height to ensure the rice grains land approximately uniformly in the square. 
2. 
