...
- We have investigated a real world phenomenon mathematically and used a combination of analyis and computer programming to understand behaviour. These principles could equally well be applied to other problems (e.g. financial markets, signals from medical devices etc.)
