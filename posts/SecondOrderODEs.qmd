...
\mathbf{F}=m\mathbf{a},
$$
where  $\mathbf{a}$  represents the acceleration of a particle, $\mathbf{F}$ the resultant force acting on it and $m$ the conatant particle mass.
...
The app in @fig-popmodel allows you to explore the solution of the model (@eq-secondorderode and @eq-secondorderodeic). 
