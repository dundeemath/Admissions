...
Infectious diseases can place a severe burden on the health service.

Infectious diseases can be characterised using the basic reproduction number.
...
We can use mathematics to study the dynamics of an infectious disease within a population. 

At Dundee, the tools needed are developed in modules such as:
...
The SIR is the most basic way to model the spread of an infectious disease.
