...
categories: [Infectious diseases, Population dynamics, Calculus]
...
In the app below we  simulating a model of infectious disease (more details on the model below). 
