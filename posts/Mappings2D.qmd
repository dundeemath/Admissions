...
def server(input: Inputs, output: Outputs, session: Session):
    ...
    def plot():
        ...
        transform=trans
        tform,dst,src,rows, cols,dst_cols,dst_rows= ChooseTransform(transform,image.shape,a,4,old_centre) 
        ...
        tform,dst,src,rows, cols,dst_cols,dst_rows= ChooseTransform(transform,new_image_trans.shape,a,30,old_centre)
...
We can build more composite maps by using the output image from one transform as the input image for another. In @fig-dtCompositeApp you can explore the effect of combining two transforms successively.
