...
If you paste the message into  @fig-decrypt, you can decrypt it if you can guess the *shared secret* used to encrypt the original message (Hint: use the slider to try different values of the shared secret ... it is smaller than 110 for this example).
...
app_ui = ui.page_fluid(
    ui.layout_sidebar(
        ui.sidebar(
    ui.input_slider(id="shared_secret",label="shared secret",min=10,max=400,value=23,step=1),
...
app_ui = ui.page_fluid(
    ui.layout_sidebar(
        ui.sidebar(
    ui.input_slider(id="p",label="p",min=10,max=500,value=23,step=1),
...
def server(input, output, session):
    ...
    def result():
        ...
        bob_public_key=int(np.mod(g**(a),p))
        alice_public_key=int(np.mod(g**(b),p))
...
app_ui = ui.page_fluid(
    ui.layout_sidebar(
        ui.sidebar(
    ui.input_slider(id="p",label="p (prime number)",min=10,max=300,value=23,step=1),
...
app_ui = ui.page_fluid(
    ui.layout_sidebar(
        ui.sidebar(
    ui.input_slider(id="p",label="p",min=10,max=300,value=23,step=1),
