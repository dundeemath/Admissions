...
categories: [Difference Equations, Discrete maths]
filters:
  - shinylive
---
...
Given numerical values for $a$ and $b$ and an initial condition, $x_0$, one can compute a sequence which is a solution to @eq-linrecurrence. This type of task is laborious and well suited to a computer. In @fig-popmodel you can explore computed solutions of @eq-linrecurrence.
...
Note that the right-hand side is a quadratic function of $x_n$. 
...
The logistic map provide one of the simplest formulation examples of a phenomenon known as chaos. A precise definition of chaos involves some technial concepts, chaotic systems are usually characterised by:
